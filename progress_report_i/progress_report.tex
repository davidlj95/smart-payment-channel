...
\usepackage{graphicx}
\usepackage{float}
\usepackage[superscript]{cite} % cites in superscript
\graphicspath{{images/}}
\usepackage{ifthen}
\usepackage{ifpdf}
\ifpdf
...
\setcounter{section}{0}
\include{02-bitcoin-study}
\setcounter{chapter}{3}
\setcounter{section}{0}
\include{03-software-framework}
\setcounter{chapter}{4}
\setcounter{section}{0}
\include{04-unidir-pc}
\setcounter{chapter}{5}
\setcounter{section}{0}
\include{05-goals}
\setcounter{chapter}{6}
\setcounter{section}{0}
\include{06-methodology}
\setcounter{chapter}{7}
\setcounter{section}{0}
\include{07-schedules}
\appendix
